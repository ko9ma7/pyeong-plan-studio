...
상단 **기본 템플릿** 메뉴 또는 새 도면 시작 화면의 **기본 템플릿에서 시작** 버튼에서 대표 도면을 바로 불러올 수 있습니다.

- 아파트: 18평형 2룸 / 24평형 3룸 / 32평형 3룸 / 42평형 4룸
- 단독주택: 20평 / 30평 / 40평 / 50평 — 대지와 마당이 포함된 기준안
- 공장: 100평 / 200평 / 300평 / 500평 — 생산, 창고, 관리, 상하차 공간 기준안
- 사무실: 20평 / 40평 / 80평 / 150평 — 오픈오피스, 회의실, 임원실, 라운지 등 기준안

총 16개 템플릿은 `src/templates.js`에서 별도 관리됩니다. 템플릿을 불러오면 새로운 프로젝트 ID로 복제되므로 원본 템플릿은 변경되지 않으며, 외곽·방·문·창문을 일반 도면처럼 자유롭게 편집한 뒤 **내 도면 저장**으로 별도 저장할 수 있습니다.

> 템플릿의 평수와 배치는 빠른 편집 시작을 위한 대표 규모입니다. 전용면적·공급면적·법정 대지/건축면적 또는 인허가용 표준도면을 의미하지 않습니다.
